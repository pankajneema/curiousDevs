    ...
    <section id="roadmap" className="border-b border-hairline py-28">
      <div className="mx-auto max-w-6xl px-6">
        <div className="grid gap-16 lg:grid-cols-[1fr_0.85fr]">
          <div>
            <p className="eyebrow">The path from service to IP</p>
            <h2 className="mt-4 text-[clamp(1.85rem,4.5vw,3rem)] leading-[1.02] font-extrabold tracking-[-0.03em]">
              Focused, <span className="text-muted-foreground">but in order.</span>
            </h2>
          ...
          <div className="card-lift panel-sheen rounded-none border border-hairline bg-surface p-8">
            ...
            <p className="mt-4 text-2xl leading-snug">
              &ldquo;Every AI system should have a measurable baseline, a clear owner, and an
              operating path its team can trust.&rdquo;
            </p>
